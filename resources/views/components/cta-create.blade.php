            ...
            <div class="row align-items-center position-relative z-2">
                ...
                <div class="col-lg-7 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <h2 class="display-5 fw-bold text-white mb-3">
                        Hai una ricetta segreta <br class="d-none d-md-inline">da condividere?
                    </h2>
                    <p class="text-white-50 lead-sm mb-0 max-w-xl">
                        Unisciti alla nostra community. Inserisci i tuoi piatti, descrivi i passaggi, imposta tempi e
                        difficoltà. Potrai modificare o aggiornare le tue creazioni in ogni momento.
                    </p>
                </div>
                ...
                <div class="col-lg-5 text-center text-lg-end">
                    <div class="d-inline-flex flex-column align-items-center align-items-lg-end">
                        ...
                        <small class="text-white-50 d-block">
                            <i class="bi bi-shield-check me-1"></i> Richiede meno di 2 minuti
                        </small>
                    </div>
                </div>
